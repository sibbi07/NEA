            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if self.play_button.check_for_input(self.menu_mouse_pos):
                        self.play()
                    if self.settings_button.check_for_input(self.menu_mouse_pos):
                        self.settings()
        ...
        while True:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    sys.exit()
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if self.back_button.check_for_input(self.settings_mouse_pos):
                        self.main_menu()
        ...
        while True:
            ...
            if self.player.game_over == False:
                for enemy in enemy_group:
                    enemy.update()
                    enemy.draw(self.window, self.camera_offset_x, self.camera_offset_y)
